...
def main():
    ...
    try:
        ...
        episodic_file.write_text("""# Session 1
...
""")
        ...
        semantic_file.write_text("""# User Preferences
...
""")
        ...
        procedural_file.write_text("""# Coding Workflow
...
""")
        ...
        semantic_file.write_text(semantic_file.read_text() + """
## New Learning
